...
1.2. **[Instalar Node.js](#2-instalar-nodejs)**
1.3. **[Modificar Directivas en PowerShell](#3-modificar-directivas-en-powershell)**
1.4. **[Instalar Instalar Android Studio](#4-instalar-instalar-android-studio)**
1.5. **[Crear el Emulador de Android Studio](#5-crear-el-emulador-de-android-studio)**
1.6. **[Configurar las variables de Entorno del Sistema](#6-configurar-las-variables-de-entorno-del-sistema)**
1.7. **[Instalar Expo Go en el Celular](#7-instalar-expo-go-en-el-celular)**
